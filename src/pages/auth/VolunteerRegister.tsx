    ...
    <div className="min-h-screen bg-gradient-to-br from-bumblebee-cream to-white py-8">
      <div className="container mx-auto px-4">
        <div className="text-center mb-8">
          <Heart className="w-16 h-16 text-bumblebee-yellow mx-auto mb-4" />
          <h1 className="text-3xl font-playfair font-bold text-bumblebee-black mb-2">
            Apply to Volunteer
          </h1>
          <p className="text-gray-600">Join our community of volunteers and make a real impact</p>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
          <Card className="glass-card">
            <CardContent className="p-8">
              <div className="text-center mb-8">
                <h2 className="text-2xl font-playfair font-bold mb-4">Volunteer Application</h2>
                <p className="text-gray-600 mb-6">
                  Complete your volunteer application to join our team of changemakers.
                </p>
              </div>

              <div className="bg-bumblebee-cream/30 rounded-lg p-8 text-center">
                <p className="text-gray-700 mb-4">
                  This will integrate with the existing volunteer application form.
                </p>
