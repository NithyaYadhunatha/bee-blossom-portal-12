...
const ReceiverLogin = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    console.log('Receiver login:', formData);
      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-playfair font-bold text-bumblebee-black mb-2">
            Meal Subscriber Login
          </h1>
          <p className="text-gray-600">Access your meal requests</p>
        </div>
          ...
          <CardContent className="p-8">
            ...
            <div className="mt-6 text-center">
              <p className="text-gray-600">
                ...
                <Link to="/auth/receiver/register" className="text-bumblebee-yellow font-semibold hover:underline">
                  Register here
                </Link>
              </p>
            </div>
